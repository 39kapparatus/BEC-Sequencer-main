...
if __name__=='__main__':
    ...
    folder_path = r'C:\Users\E3\Desktop\BEC-Sequencer-main (1)\BEC-Sequencer-main\ToF\images'
    json_folder = r'C:\Users\E3\Desktop\BEC-Sequencer-main (1)\BEC-Sequencer-main\ToF'
    ...
    for i, file in enumerate(files):
        ...
        json_file = os.path.splitext(file)[0] + '.json'  # replace extension with .json
        ...
        voltage = extract_trap_aom_voltage(json_path)
        print(voltage)

        if voltage is not None:
            voltages.append(voltage)
        else:
            print(f"Warning: Could not find Trap AOM FM voltage in {json_path}")
